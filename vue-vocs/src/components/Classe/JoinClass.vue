...
<template>
  ...
  <!--// *Top Section -->
  <!--//*---------------->
  <!--"D:/Sync/CS Dev/Vocs/vue-vocs/src/assets/Screenshots(For Commenting)/Classe/JoinClass-TopSection.png"-->
                      <v-layout row wrap >
                        <v-flex xs6 offset-xs3 class="mb-4">
                        <!-- Class Icon Section -->
                        <!--"D:/Sync/CS Dev/Vocs/vue-vocs/src/assets/Screenshots(For Commenting)/Classe/JoinClass-TopSection-Icon.png"-->
                      ...
                      <!--"D:/Sync/CS Dev/Vocs/vue-vocs/src/assets/Screenshots(For Commenting)/Classe/JoinClass-TopSection-Title.png"-->
                      <v-layout row wrap>
  ...
  <!--// *Form Section -->
  <!--//*---------------->
  <!--"D:/Sync/CS Dev/Vocs/vue-vocs/src/assets/Screenshots(For Commenting)/Classe/JoinClass-LowerSection.png"-->

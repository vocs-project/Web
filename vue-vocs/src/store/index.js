...
export const store = new Vuex.Store({
    ...
    getAndSetListsClass(state) {
      ...
      if (state.user.classes.length > 0) {
        for (var b = 0; b < state.user.classes[0].lists.length; b++) {
          Vue.http
            .get(
              "https://vocsapi.lebarillier.fr/rest/lists/" +
                state.user.classes[0].lists[b].id
            )
            .then(response => {
  ...
  actions: {
    ...
    createList({ commit, state }, payload) {
      ...
      Vue.http
        .post(
          "https://vocsapi.lebarillier.fr/rest/users/" +
            state.user.id +
            "/lists",
          list
        )
        .then(response => {
          ...
          console.log(list.id);
          console.log(
            "payload.wordTrads: " + JSON.stringify(payload.wordTrads[0])
          );
          var wordsToSend = [];
          for (var i = 0; i < payload.wordTrads.length; i++) {
            wordContent = payload.wordTrads[i].word.content.toLowerCase();
            wordContent =
              wordContent.charAt(0).toUpperCase() + wordContent.slice(1);
            tradContent = payload.wordTrads[i].trad.content.toLowerCase();
            tradContent =
              tradContent.charAt(0).toUpperCase() + tradContent.slice(1);
            wordsToSend[i] = {
              word: {
                content: wordContent,
                language: "EN"
            ...
            Vue.http
              ...
              .then(user => {
                ...
                console.log(
                  "wordTrads[" + i + "]: " + JSON.stringify(list.wordTrads[i])
                );
        ...
        .then(response => {
          ...
          if (payload.users.length > 0) {
            for (var i = 0; i < payload.users.length; i++) {
              ...
              Vue.http
                .post(
                  "https://vocsapi.lebarillier.fr/rest/demands",
                  invitationToSendOff
                )
                .then(response => {
                  theClass.users = [
                ...
                .catch(error => {
                  ...
                  this.dispatch(
                    "setSnackbarMessage",
                    "Votre classe n'a pas été créée"
                  );
                  state.loading = false;
                });
            }
        ...
        Vue.http
          ...
          .then(response => {
            ...
            if (counter >= i) {
              ...
              this.dispatch(
                "setSnackbarMessage",
                "Votre liste a bien été envoyée"
              );
              state.loading = false;
              console.log(state.myDemands);
            }
          ...
          .catch(error => {
            ...
            this.dispatch(
              "setSnackbarMessage",
              "Votre liste n'a pas été envoyée"
            );
            state.loading = false;
          });
      }
    ...
    removeList({ commit, state }, payload) {
      state.loading = true;
      Vue.http
        .delete("https://vocsapi.lebarillier.fr/rest/lists/" + payload)
        .then(
        ...
        .then(data => {
          ...
          Vue.http
            ...
            .then(data2 => {
              ...
              if (state.user.classes.length > 0) {
                if (state.user.classes[0].lists.length <= 0) {
                  state.loading = false;
                } else {
    ...
    signUserIn({ commit, state }, payload) {
      ...
      Vue.http
        .post(
          "https://vocsapi.lebarillier.fr/rest/users/authentification",
          payload
        )
        .then(user => {
          theUser = {
          ...
          Vue.http
            .get("https://vocsapi.lebarillier.fr/rest/users/" + theUser.id)
            .then(response2 => {
              return response2.json();
            })
            .then(data => {
                ...
                .then(data2 => {
                  ...
                  Vue.http
                    ...
                    .then(data3 => {
                      ...
                      Vue.http
                        .get("https://vocsapi.lebarillier.fr/rest/users")
                        .then(response3 => {
                          return response3.json();
                        })
                        .then(data4 => {
                      ...
                      Vue.http
                        .get(
                          "https://vocsapi.lebarillier.fr/rest/demands/users/" +
                            theUser.id
                        )
                        .then(response4 => {
                        ...
                        .then(data5 => {
                          ...
                          console.log(
                            "mes demandes: " + JSON.stringify(state.myDemands)
                          );
                          console.log(
                            "https://vocsapi.lebarillier.fr/rest/demands/users/" +
                              state.user.id
                      ...
                      if (JSON.stringify(theUser.roles) === '["ROLE_USER"]') {
                        ...
                        JSON.stringify(theUser.roles) === '["ROLE_STUDENT"]'
                      ) {
    ...
    signUserUp({ commit, state }, payload) {
      ...
      var theUser = {};
      Vue.http
        .post("https://vocsapi.lebarillier.fr/rest/users", user)
        .then(response => {
          theUser = {
            id: response.body.id,
            isLoggedIn: true,
        ...
        .catch(error => {
          ...
          state.loading = false;
          state.inscriptionErrorMessage =
            "Votre adresse mail est déja lié à un compte, Voulez-vous vous connectez avec?";
        });
    },
    ...
    removeStudent({ commit, state }, payload) {
      ...
      if (state.user.roles === "PROFESSOR") {
        Vue.http
          .delete(
            "https://vocsapi.lebarillier.fr/rest/classes/" +
          ...
          .then(response => {
            ...
            Vue.http
              .patch(
                "https://vocsapi.lebarillier.fr/rest/users/" + payload,
                toSendOff
              )
              .then(
        ...
        Vue.http
          ...
          .then(response => {
            ...
            Vue.http
              .patch(
                "https://vocsapi.lebarillier.fr/rest/users/" + state.user.id,
                userRole
              )
              .then(response2 => {
              ...
              .catch(error => {
                ...
                this.dispatch(
                  "setSnackbarMessage",
                  "Vous n'avez pas pu quitté la classe"
                );
                state.loading = false;
              });
          })
    ...
    removeStudentButKeepLists({ commit, state }, payload) {
      ...
      if (state.user.roles === "STUDENT") {
        for (let i = 0; i < state.user.classes[0].lists.length; i++) {
          ...
          for (
            let j = 0;
            j < state.user.classes[0].lists[i].wordTrads.length;
            j++
          ) {
            toSendOff.wordTrads.push(
              state.user.classes[0].lists[i].wordTrads[j].id
            );
          }
          console.log("TOSENDOFF: " + JSON.stringify(toSendOff));
          Vue.http
    ...
    removeClass({ commit, state }, payload) {
      ...
      if (usersInclass.length > 1) {
            ...
            Vue.http
              ...
              .then(data => {
                ...
                if (counter >= usersInclass.length - 1) {
                  Vue.http
                    .delete(
                      "https://vocsapi.lebarillier.fr/rest/classes/" + payload
                    )
                    .then(
                    ...
                    .catch(error => {
                      ...
                      this.dispatch(
                        "setSnackbarMessage",
                        "La classe n'a pas été supprimé"
                      );
                      state.loading = false;
                    });
                }
        ...
        Vue.http
          .delete("https://vocsapi.lebarillier.fr/rest/classes/" + payload)
          .then(
            commit("removeClass", payload),
            this.dispatch("setSnackbarIsEnabled", true),
            this.dispatch(
    ...
    setUserClass({ commit, state }, payload) {
      ...
      Vue.http
        .get("https://vocsapi.lebarillier.fr/rest/classes/" + payload.id)
        .then(response2 => {
          return response2.json();
        })
        .then(data2 => {
          ...
          Vue.http
            ...
            .then(data => {
              ...
              if (JSON.stringify(data.lists) === "[]") {
                ...
                console.log("i: " + i);
                console.log(
                  "allListsOfAllClasses:" +
                    JSON.stringify(allListsOfAllTickedClasses)
                );
              }
              counter++;
              if (counter >= amountOfTickedClasses) {
                ...
                for (var y = 0; y < allListsOfAllTickedClasses.length; y++) {
                  for (
                    var j = 0;
                    j < allListsOfAllTickedClasses[y].lists.length;
                    j++
                  ) {
                    patchToSendOff.lists[j] =
                      allListsOfAllTickedClasses[y].lists[j].id;
                  }
                  ...
                  console.log(
                    "lists of class[" +
                      y +
                      "]: " +
                      JSON.stringify(patchToSendOff.lists)
                  );
                  console.log(
                    "Vue.http.patch('https://vocsapi.lebarillier.fr/rest/classes/" +
                      allListsOfAllTickedClasses[y].id +
                      ", " +
                      patchToSendOff.lists +
                      ")"
                  );
                  ...
                  Vue.http
                    ...
                    .then(response => {
                      ...
                      if (classesPatched >= allListsOfAllTickedClasses.length) {
                        ...
                        this.dispatch(
                          "setSnackbarMessage",
                          "La liste a bien été ajoutée à la classe"
                        );
                    ...
                    .catch(error => {
                      ...
                      this.dispatch(
                        "setSnackbarMessage",
                        "La liste n'a pas été ajoutée à la classe"
                      );
                      state.loading = false;
                    });
                }
    ...
    deleteDemand({ commit, state }, payload) {
      state.loading = true;
      Vue.http
        .delete("https://vocsapi.lebarillier.fr/rest/demands/" + payload)
        .then(commit("deleteDemand", payload), (state.loading = false))
        .catch(error => {
          console.log(error);
          state.loading = false;
        });
    ...
    deleteDemand2({ commit, state }, payload) {
      ...
      Vue.http
        .delete("https://vocsapi.lebarillier.fr/rest/demands/" + payload)
        .then(commit("deleteDemand2", payload), (state.loading = false))
        .catch(error => {
          console.log(error);
          state.loading = false;
        });
    ...
    getClasses({ commit, state }, payload) {
      Vue.http
        .get("https://vocsapi.lebarillier.fr/rest/classes/" + payload)
        .then(response => {
    ...
    addUserToClass({ state }, payload) {
      ...
      Vue.http
        .patch(
          "https://vocsapi.lebarillier.fr/rest/users/" + payload.userId,
          toSendOff
        )
        .then(response => {
          console.log(
    ...
    addListToUser({ commit, state }, payload) {
      ...
      var wordTradIds = [];
      Vue.http
        .get("https://vocsapi.lebarillier.fr/rest/lists/" + payload.listId)
        .then(response => {
          return response.json();
        })
        .then(data => {
          ...
          Vue.http
            ...
            .catch(error => {
              ...
              this.dispatch(
                "setSnackbarMessage",
                "Votre liste n'a pas pu être ajoutée"
              );
              state.loading = false;
            });
        });
    ...
    getSchools({ commit, state }) {
      state.loading = true;
      Vue.http
        .get("https://vocsapi.lebarillier.fr/rest/schools")
        .then(response => {
          return response.json();
        })
        .then(data => {
    ...
    getSchoolsAndClasses({ commit, state }) {
      ...
      Vue.http
        ...
        .then(data => {
          state.schools = data;
          Vue.http
            .get("https://vocsapi.lebarillier.fr/rest/classes")
            .then(response3 => {
              return response3.json();
            })
            .then(data4 => {
    ...
    modifyProfil({ commit, state }, payload) {
      ...
      Vue.http
        ...
        .then(
          ...
          this.dispatch("resetEditProfile"),
          this.dispatch("setSnackbarIsEnabled", true),
          this.dispatch(
            "setSnackbarMessage",
        ...
        .catch(error => {
          ...
          this.dispatch(
            "setSnackbarMessage",
            "Votre profil n'a pas pu être modifié"
          );
          state.isConfirmingPassword = false;
          state.loading = false;
        });
      ...
      if (state.user.roles === "STUDENT") {
        Vue.http
          ...
          .then(data2 => {
            for (var i = 0; i < data2.users.length; i++) {
              if (
                JSON.stringify(data2.users[i].roles) === '["ROLE_PROFESSOR"]'
              ) {
                userReceiveId = data2.users[i].id;
              }
            }
    ...
    addSynonyme({ commit, state }, payload) {
      ...
      Vue.http
        .patch(
          "https://vocsapi.lebarillier.fr/rest/words/" +
            payload.wordTrad.trad.id,
          toSendOff
        )
        .then(
          this.dispatch("setSnackbarIsEnabled", true),
        ...
        .catch(error => {
          ...
          this.dispatch(
            "setSnackbarMessage",
            "Le Synonyme n'a pas pu être ajouté"
          );
          state.loading = false;
        });
    },
  ...
  getters: {
    ...
    theTeacherInTheClass(state) {
      for (var i = 0; i < state.user.classes[0].users.length; i++) {
        if (
          JSON.stringify(state.user.classes[0].users[i].roles) ===
          '["ROLE_PROFESSOR"]'
        ) {
